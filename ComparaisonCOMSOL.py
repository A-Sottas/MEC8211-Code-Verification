...
Vn = np.array([301,1501,3001]) #Choix du nombre de points dans le maillage

dt = 365*24*3600 #Base de temps en seconde
...
COMSOL_301 = np.loadtxt("Valeurs1D_S_avec_kC_quadratique_301.txt")
COMSOL_1501 = np.loadtxt("Valeurs1D_S_avec_kCquadratique_header_1501.txt",comments="%")
COMSOL_3001 = np.loadtxt("Valeurs1D_S_avec_kCquadratique_header_3001.txt",comments="%")

solCOMSOL.append(COMSOL_301[:,1])
...
err1.legend()
err1.grid()
err1.set_title("Tracé de l'erreur L2 en fonction de la taille du maillage")
err1.set_xlabel('dt')
